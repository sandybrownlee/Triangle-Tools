...
final class Token extends Object {
	...
	//The Token class contains two lists of tokens (names of them, and the actual reserved words if applicable).
	// When we make a new Token object, if we give it type==IDENTIFIER then we take a look through the list for
	// any reserved words and fix to that if found.
