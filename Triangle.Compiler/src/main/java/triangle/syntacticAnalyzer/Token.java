...
final class Token extends Object {
	...
	INTLITERAL = 0, CHARLITERAL = 1, IDENTIFIER = 2, OPERATOR = 3,
			...
			ARRAY = 4, BEGIN = 5, CONST = 6, DO = 7, ELSE = 8, END = 9, FUNC = 10, IF = 11, IN = 12, LET = 13, LOOP = 14, OF = 15, PROC = 16, RECORD = 17, REPEAT = 18, THEN = 19, TYPE = 20, UNTIL = 21,  VAR = 22, WHILE = 23,
