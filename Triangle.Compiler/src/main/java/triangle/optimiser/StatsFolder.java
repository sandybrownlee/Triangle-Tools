...
//import triangle.abstractSyntaxTrees.terminals.expressions.*;
...
public final class StatsFolder implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	public AbstractSyntaxTree visitBinaryExpression(BinaryExpression ast, Void arg) {
		statsTable.addEntry("BinaryExpression");
		ast.E1.visit(this);
		ast.E2.visit(this);
		ast.O.visit(this);
	...
	public AbstractSyntaxTree visitWhileCommand(WhileCommand ast, Void arg) {
		statsTable.addEntry("WhileCommand");
	...
	public void count(Program ast) {
		ast.visit(this);
	}

	public StatsFolder(StatsTable stats) {
		this.statsTable = stats;
	}
