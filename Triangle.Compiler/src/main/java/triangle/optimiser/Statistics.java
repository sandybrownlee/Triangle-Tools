...
public class Statistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    public int binaryExpresstionCount = 0;
    public int ifCommandCount = 0;
    public int whileCommandCount = 0;

    public String printStatistics(){

        String output = "Binary Expressions visited: " + binaryExpresstionCount +
                "\n" +
                "If Commands visited: " + ifCommandCount +
                "\n" +
                "While Commands visited: " + whileCommandCount ;
