...
public class SummaryStatisticsGenerator implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
	...
	public void printSummaryStatistics() {
			System.out.println("Amount of Binary Expressions: " + Integer.toString(BinaryExpressionCounter));
			System.out.println("Amount of If Commands: " + Integer.toString(IfCommandCounter));
			System.out.println("Amount of While Commands: " + Integer.toString(WhileCommandCounter));
	}
...
@Override
	...
	@Override
		public AbstractSyntaxTree visitBinaryExpression(BinaryExpression ast, Void arg) {
			BinaryExpressionCounter += 1; //Task 6
