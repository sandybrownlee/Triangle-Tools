package triangle.statsAnalyzer;
...
public class Statistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    public void read(Program theAST) {
        // Count BinaryExpressions, IfCommands and WhileCommands
        theAST.visit(this);
        System.out.println("BinaryExpressions: " + binaryExpressionCount);
        System.out.println("IfCommands: " + ifCommandCount);
        System.out.println("WhileCommands: " + whileCommandCount);
    }
}