...
import triangle.abstractSyntaxTrees.commands.LoopWhileCommand; //Task 5
...
@Override
	...
	public DrawingTree visitBinaryExpression(BinaryExpression ast, Void obj) {
		...
		return layoutTernary("Bin.Expr. " + "(" + d2.caption + ")", d1, d2, d3); //Task 2
	}
	...
	public DrawingTree visitUnaryExpression(UnaryExpression ast, Void obj) {
		...
		var d2 = ast.E.visit(this);
		return layoutBinary("UnaryExpr. " + "(" + d1.caption + ")", d1, d2); //Task 2
	}
