...
VnameVisitor<Void, AbstractSyntaxTree> {
    ...
    private int countBinaryExpressions = 0;
    public int getcountBinaryExpressions(){return countBinaryExpressions;};
    private int countIfCommands = 0;
    public int getcountIfCommands(){return countIfCommands;};
    private int countWhileCommands = 0;
    public int getcountWhileCommands(){return countWhileCommands;};
