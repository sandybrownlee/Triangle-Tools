...
public class Statistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    int counterBinaryExpressions = 0;
    int counterIfCommands = 0;
    int counterWhileCommands = 0;

    private void addBinaryExpression() {
        this.counterBinaryExpressions++ ;
    }
    private void addIfCommand() {
        this.counterIfCommands++ ;
    }
    private void addWhileCommand() {
        this.counterWhileCommands++ ;
    }
