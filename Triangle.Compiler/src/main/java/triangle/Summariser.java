...
public class Summariser implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
...
VnameVisitor<Void, AbstractSyntaxTree>{
    ...
    private int numBinaryExpressions = 0;
    private int numIfCommands = 0;
    private int numWhileCommands = 0;

    public int getNumBinaryExpressions() {
        return numBinaryExpressions;
    }
    public int getNumIfCommands() {
        return numIfCommands;
    }
    public int getNumWhileCommands() {
        return numWhileCommands;
    }
    ...
    @Override
    public AbstractSyntaxTree visitUnaryCommand(UnaryCommand ast, Void arg) {
        ast.V.visit(this);
		ast.O.visit(this);
        return null;
    }
