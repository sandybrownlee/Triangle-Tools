...
public class ProgramStatistics implements ActualParameterVisitor<Void, AbstractSyntaxTree>,
    ...
    private int binaryExpressionsCount = 0, ifCommandsCount = 0, whileCommandsCount = 0;

    public void printStats() {
        //print statistics of triangle program
        System.out.println(
                "\nNumber of binary expressions: " + String.valueOf(binaryExpressionsCount) + "\n"
                + "Number of if commands: " + String.valueOf(ifCommandsCount) + "\n"
                + "Number of while commands: " + String.valueOf(whileCommandsCount) + "\n"
        );
    }
